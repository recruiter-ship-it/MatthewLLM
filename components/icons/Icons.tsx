...
export const Sparkles: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M9.9,2.2l1.1,2.3c0.1,0.3,0.4,0.5,0.7,0.5l2.5,0.4c0.7,0.1,1,1,0.5,1.5l-1.9,1.8c-0.2,0.2-0.3,0.5-0.3,0.8l0.4,2.5c0.1,0.7-0.6,1.2-1.2,0.9L9.4,11.5c-0.3-0.1-0.6-0.1-0.9,0L6.2,12.8c-0.7,0.3-1.4-0.2-1.2-0.9l0.4-2.5c0.1-0.3,0-0.6-0.2-0.8L3.2,7c-0.5-0.5-0.2-1.4,0.5-1.5L6.3,5c0.3,0,0.6-0.2,0.7-0.5l1.1-2.3C8.5,1.5,9.5,1.5,9.9,2.2z"/>
      <path d="M18.8,12.8l0.9,1.8c0.2,0.4,0.7,0.7,1.2,0.6l2-0.3c0.6-0.1,1.1,0.7,0.7,1.2l-1.5,1.5c-0.3,0.3-0.4,0.7-0.3,1.1l0.6,2c0.2,0.6-0.4,1.1-1,0.9l-1.8-0.9c-0.4-0.2-0.8-0.2-1.2,0l-1.8,0.9c-0.6,0.2-1.1-0.4-1-0.9l0.6-2c0.1-0.4,0-0.8-0.3-1.1l-1.5-1.5c-0.4-0.4,0.1-1.2,0.7-1.2l2,0.3c0.4,0.1,0.9-0.2,1.2-0.6l0.9-1.8C17.7,12.1,18.7,12.1,18.8,12.8z"/>
    </svg>
  );
...
export const ThumbsUp: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M7 10v12" />
    <path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2h0a2 2 0 0 1 2 2Z" />
  </svg>
);
...
export const ThumbsDown: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M17 14V2" />
    <path d="M9 18.12 10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H20a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.76a2 2 0 0 0-1.79 1.11L12 22h0a2 2 0 0 1-2-2Z" />
  </svg>
);
...
export const FireIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M10.67 6.33a2 2 0 0 0-1.34 3.67 2 2 0 0 1-3 3.67 2 2 0 0 0-1 3.66C6.83 20.33 12 22 12 22s5.17-1.67 6.67-4.67a2 2 0 0 0-1-3.66 2 2 0 0 1-3-3.67 2 2 0 0 0-1.33-3.67Z"/>
    <path d="M12 4a2 2 0 0 0-2 2c0 1.67 1.33 3 3 3s3-1.33 3-3a2 2 0 0 0-2-2Z"/>
  </svg>
);
...
export const Plug: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M18 17h-2.5a2.5 2.5 0 0 0-5 0H8.5a2.5 2.5 0 0 0-5 0H2"/>
    </svg>
);
